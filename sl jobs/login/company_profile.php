    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="profile_info">
                <img src="images/company_profile.png" width="3%">
                    <?php  if (isset($_SESSION['user'])) : ?>
                    <strong><?php echo $_SESSION['user']['username']; ?></strong>

                    <small>
                        <i  style="color: #888;">(<?php echo ucfirst($_SESSION['user']['user_type']); ?>)</i>&nbsp; 
                        <a href="vacancies.php" style="color: red;">Upload Your Vacancy Here</a>
                        <a href="company_profile.php?logout='1'" style="color: red;">logout</a>
                    </small>
